...
\item{International Conferences on Learning Representations (ICLR): 2019, 2022}
...
\item{Annual Conferences on Neural Information Processing Systems (NIPS/NeurIPS): 2014, 2017--2021}
...
%\item{\myself, M. Shao, Z. Zheng, C. He, and Z.-H. Du: Typical XML document transformation methods and an application system (in Chinese). \venuefont{Computer Science}, 30(2):40--44, February, 2003.}
...
\item{X. Chen, J. Hu, C. Jin, \myself, and L. Wang: Near-optimal representation learning for linear bandits and linear RL. In \venuefont{the 38th International Conference on Machine Learning (ICML)}, 2021.}
